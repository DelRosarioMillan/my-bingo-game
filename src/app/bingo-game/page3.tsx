...
const checkWin = (board: any[][], mode: GameMode) => {
  switch (mode) {
    case 'classic':
      ...
      if (board.every((row, index) => row[index].marked)) return true;
      
      // Verificar diagonal secundaria
      if (board.every((row, index) => row[4 - index].marked)) return true;
        ...
        <div className="grid grid-cols-5 gap-1" role="table" aria-label={`Cartón de Bingo ${index + 1}`}>
          ...
          {board.flat().map((cell, cellIndex) => (
            <motion.div
              ...
              role="cell"
              aria-label={`${BINGO_LETTERS[Math.floor(cellIndex / 5)]}${cell.number}, ${cell.marked ? 'marcado' : 'no marcado'}`}
            >
              {cell.number}
            </motion.div>
          ))}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select value={gameMode} onValueChange={(value: GameMode) => setGameMode(value)}>
                  <SelectTrigger className="w-full mt-2" id="gameMode">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2" aria-label="Números más frecuentes">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2" aria-label="Números sacados en esta ronda">
